...
LIBRARIES = s21_graph s21_graph_algorithms

EXECUTABLES = s21_graph_cli
...
$(TEST_EXECUTABLES): export TEST_LIBRARIES =  $(BINARY_ROOT)/s21_graph/s21_graph.a $(BINARY_ROOT)/s21_graph_algorithms/s21_graph_algorithms.a
...
Projects:
	...
	$(PROJECTS) - build specified project
